...
import com.geekbrains.spring.web.cart.integrations.StatisticServiceIntegration;
...
//    public ProductDto statistiс( Long productId) {
//        // Get получаем обект корзина из редиса
//        // Update делаем изменения добав товар, удаляем и тд
//        // Set записали обратно в редис
//        ProductDto productDto = productsServiceIntegration.findById(productId).orElseThrow(() -> new ResourceNotFoundException("Невозможно добавить продукт в статистику. Продукт не найдет, id: " + productId));
//       return  productDto;
//    }
